...
主要敗因幾乎都是 `break-level-limit`。豆子自動策略常把低 HP、低等級餅乾補上戰鬥區，導致豆子破壞區等級快速堆高（平均 9.8），而紅色只有 6.9。

## 敗局分析

23 場敗局中，21 場豆子破壞區等級 >= 8。
...
**關鍵發現：**
- 豆子有大量 HP 1 餅乾（Angel、Spinach、Bellflower、Cookiemals）被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：Cookiemals (Lv1)、2 個 Bellflower (Lv1)、Angel (Lv1)、Lemon Thyme (Lv2)、Melon Bun (Lv1)、Banana (Lv1)、Ninja (Lv1)、Cookiemals (Lv1)
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：4 個 Angel (Lv1)、Banana (Lv1)、Salt (Lv1)、Bellflower (Lv1)、Cookiemals (Lv1)、Onion (Lv2)
- 紅色破壞區有 5 張：Mala Sauce (Lv2)、2 個 Popcorn (Lv1)、Melon Bun (Lv1)、Dark Choco (Lv2)
- 豆子棄牌 22 張，紅色 24 張

**教訓：** 豆子有 4 個 Angel Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Red Bean (Lv2)、Lemon Thyme (Lv2)、Cookiemals (Lv1)、Bellflower (Lv1)、Onion (Lv2)、Melon Bun (Lv1)、Banana (Lv1)
- 紅色破壞區有 6 張：Popcorn (Lv1)、Carrot (Lv1)、Adventurer (Lv1)、Carrot (Lv1)、Princess (Lv2)、Mala Sauce (Lv2)
- 豆子棄牌 24 張，紅色 12 張

**教訓：** 豆子有 3 個 Lv2 餅乾（Red Bean、Lemon Thyme、Onion）被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Candlelight (Lv1)、Red Bean (Lv2)、Spinach (Lv1)、Red Bean (Lv2)、2 個 Salt (Lv1)、Bellflower (Lv1)、Cookiemals (Lv1)
- 紅色破壞區有 8 張：3 個 Adventurer (Lv1)、2 個 Carrot (Lv1)、Princess (Lv2)、Popcorn (Lv1)、Melon Bun (Lv1)
- 豆子棄牌 34 張，紅色 17 張

**教訓：** 豆子棄牌 34 張，資源管理嚴重有問題
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Banana (Lv1)、Cookiemals (Lv1)、Ninja (Lv1)、Lemon Thyme (Lv2)、2 個 Red Bean (Lv2)、Salt (Lv1)
- 紅色破壞區有 6 張：Adventurer (Lv1)、Popcorn (Lv1)、Carrot (Lv1)、Popcorn (Lv1)、Adventurer (Lv1)、Mala Sauce (Lv2)
- 豆子棄牌 29 張，紅色 10 張

**教訓：** 豆子有 2 個 Red Bean Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Spinach (Lv1)、Cookiemals (Lv1)、2 個 Lemon Thyme (Lv2)、Onion (Lv2)、2 個 Ninja (Lv1)、Melon Bun (Lv1)
- 紅色破壞區有 7 張：3 個 Popcorn (Lv1)、2 個 Carrot (Lv1)、Cherry (Lv2)、Princess (Lv2)
- 豆子棄牌 24 張，紅色 12 張

**教訓：** 豆子破壞區等級 11，且有 2 個 Lemon Thyme Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **4 張餅乾**：2 個 Spinach (Lv1)、Candlelight (Lv1)、Red Bean (Lv2)
- 紅色破壞區沒有餅乾
- 豆子棄牌 15 張，紅色只有 2 張
- 7 回合就結束，豆子沒有餅乾可用
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Bellflower (Lv1)、Angel (Lv1)、Spinach (Lv1)、2 個 Lemon Thyme (Lv2)、Bellflower (Lv1)、Cookiemals (Lv1)、Banana (Lv1)
- 紅色破壞區有 6 張：Popcorn (Lv1)、Adventurer (Lv1)、Carrot (Lv1)、Adventurer (Lv1)、Mala Sauce (Lv2)、Adventurer (Lv1)
- 豆子棄牌 28 張，紅色 14 張

**教訓：** 豆子有 2 個 Bellflower Cookie 和 2 個 Lemon Thyme Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：Spinach (Lv1)、Angel (Lv1)、Red Bean (Lv2)、Bellflower (Lv1)、Banana (Lv1)、Candlelight (Lv1)、Angel (Lv1)、Melon Bun (Lv1)、Candlelight (Lv1)
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Onion (Lv2)、Lemon Thyme (Lv2)、Red Bean (Lv2)、Bellflower (Lv1)、Banana (Lv1)、Angel (Lv1)、Spinach (Lv1)
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：Melon Bun (Lv1)、Spinach (Lv1)、Angel (Lv1)、Lemon Thyme (Lv2)、Salt (Lv1)、Bellflower (Lv1)、Melon Bun (Lv1)、Angel (Lv1)、Onion (Lv2)
- 紅色破壞區有 6 張：Adventurer (Lv1)、Dark Choco (Lv2)、Popcorn (Lv1)、Princess (Lv2)、Whipped Cream (Lv2)、Carrot (Lv1)
- 豆子棄牌 29 張，紅色 24 張

**教訓：** 豆子破壞區等級 11，且有大量 Lv1 餅乾
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Candlelight (Lv1)、Spinach (Lv1)、Red Bean (Lv2)、Onion (Lv2)、Banana (Lv1)、Cookiemals (Lv1)、Spinach (Lv1)、Lemon Thyme (Lv2)
- 紅色破壞區有 7 張：Popcorn (Lv1)、Princess (Lv2)、Mala Sauce (Lv2)、4 個 Popcorn (Lv1)、Adventurer (Lv1)
- 豆子棄牌 18 張，紅色 15 張

**教訓：** 豆子破壞區等級 11，且有 2 個 Spinach Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Cookiemals (Lv1)、Bellflower (Lv1)、Spinach (Lv1)、Red Bean (Lv2)、Bellflower (Lv1)、Melon Bun (Lv1)、Salt (Lv1)、Ninja (Lv1)
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：Ninja (Lv1)、Candlelight (Lv1)、Angel (Lv1)、Banana (Lv1)、Ninja (Lv1)、Spinach (Lv1)、Salt (Lv1)、Red Bean (Lv2)、Lemon Thyme (Lv2)
...
**關鍵問題：**
- 豆子破壞區有 **6 張餅乾**：Spinach (Lv1)、Lemon Thyme (Lv2)、Red Bean (Lv2)、Banana (Lv1)、Angel (Lv1)、Blue Lily (Lv3)
- 紅色破壞區有 5 張：Carrot (Lv1)、Adventurer (Lv1)、Muscle (Lv2)、2 個 Cherry (Lv2)
- 豆子棄牌 17 張，紅色 12 張

**教訓：** 豆子把 Lv3 餅乾（Blue Lily）也送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Spinach (Lv1)、2 個 Lemon Thyme (Lv2)、Angel (Lv1)、Melon Bun (Lv1)、Onion (Lv2)、Candlelight (Lv1)
- 紅色破壞區有 4 張：Melon Bun (Lv1)、Popcorn (Lv1)、Adventurer (Lv1)、Carrot (Lv1)
- 豆子棄牌 17 張，紅色 17 張

**教訓：** 豆子有 2 個 Lemon Thyme Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **9 張餅乾**：3 個 Angel (Lv1)、Bellflower (Lv1)、Onion (Lv2)、2 個 Melon Bun (Lv1)、Salt (Lv1)、Banana (Lv1)
- 紅色破壞區有 4 張：Mala Sauce (Lv2)、Adventurer (Lv1)、Carrot (Lv1)、Muscle (Lv2)
- 豆子棄牌 37 張，紅色 13 張

**教訓：** 豆子棄牌 37 張，資源管理嚴重有問題
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Spinach (Lv1)、2 個 Angel (Lv1)、Cookiemals (Lv1)、2 個 Lemon Thyme (Lv2)、Ninja (Lv1)、Candlelight (Lv1)
- 紅色破壞區有 8 張：Dark Choco (Lv2)、3 個 Adventurer (Lv1)、Popcorn (Lv1)、Carrot (Lv1)、Popcorn (Lv1)、Melon Bun (Lv1)
- 豆子棄牌 17 張，紅色 22 張

**教訓：** 豆子有 2 個 Angel Cookie 和 2 個 Lemon Thyme Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Red Bean (Lv2)、Onion (Lv2)、Salt (Lv1)、Bellflower (Lv1)、Angel (Lv1)、Spinach (Lv1)、Banana (Lv1)、Blue Lily (Lv3)
- 紅色破壞區有 6 張：2 個 Adventurer (Lv1)、Carrot (Lv1)、Mala Sauce (Lv2)、Adventurer (Lv1)、Carrot (Lv1)
- 豆子棄牌 0 張，紅色 10 張

**教訓：** 豆子破壞區等級 12，且把 Lv3 餅乾（Blue Lily）也送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Melon Bun (Lv1)、Lemon Thyme (Lv2)、Spinach (Lv1)、2 個 Angel (Lv1)、Onion (Lv2)、Red Bean (Lv2)
- 紅色破壞區有 5 張：Cherry (Lv2)、Popcorn (Lv1)、Princess (Lv2)、Adventurer (Lv1)、Cherry (Lv2)
- 豆子棄牌 18 張，紅色 19 張

**教訓：** 豆子有 2 個 Angel Cookie 被送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **4 張餅乾**：2 個 Angel (Lv1)、Banana (Lv1)、Cookiemals (Lv1)
...
**關鍵問題：**
- 豆子破壞區有 **7 張餅乾**：Cookiemals (Lv1)、2 個 Onion (Lv2)、2 個 Spinach (Lv1)、Banana (Lv1)、Blue Lily (Lv3)
- 紅色破壞區有 6 張：Adventurer (Lv1)、Popcorn (Lv1)、Mala Sauce (Lv2)、Rebel (Lv2)、Dark Choco (Lv2)、Carrot (Lv1)
- 豆子棄牌 19 張，紅色 22 張

**教訓：** 豆子破壞區等級 11，且把 Lv3 餅乾（Blue Lily）也送進破壞區
...
**關鍵問題：**
- 豆子破壞區有 **8 張餅乾**：Banana (Lv1)、Spinach (Lv1)、Lemon Thyme (Lv2)、Candlelight (Lv1)、Bellflower (Lv1)、Spinach (Lv1)、Onion (Lv2)、Bellflower (Lv1)
- 紅色破壞區有 5 張：2 個 Popcorn (Lv1)、Adventurer (Lv1)、2 個 Princess (Lv2)
- 豆子棄牌 26 張，紅色 13 張

**教訓：** 豆子有 2 個 Spinach Cookie 和 2 個 Bellflower Cookie 被送進破壞區
...
**平均破壞區等級：** 豆子 9.8，紅色 6.9

## 關鍵操作心得（豆子對紅色）

### 1. 替補不要選最低 HP

豆子現有 AI 傾向補低 HP 餅乾，對紅色很危險。
...
豆子若把 HP 1 餅乾放成第二隻，紅色常能用攻擊或效果快速換掉。
...
不要只用「最低 HP」作為唯一目標。紅色有些低 HP 餅乾（Popcorn、Carrot、Adventurer）即使擊倒也對豆子幫助不大。
...
5. **節奏**：豆子靠回復與耐久取勝，早期建立防線，後期讓紅色破壞區先滿
