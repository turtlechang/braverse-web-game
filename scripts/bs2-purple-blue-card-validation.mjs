...
const screenshotDir = resolve(tmpdir(), 'braverse-bs2-purple-blue-screenshots')
...
// --- 40 BS2 PURPLE + 40 BS2 BLUE unique card numbers ------------------------
const PURPLE_CARDS = [
  ['BS2-052', 'Kumiho Cookie'],
  ['BS2-053', 'Ninja Cookie'],
  ['BS2-054', 'Dino-Sour Cookie'],
  ['BS2-055', 'Poison Mushroom Cookie'],
  ['BS2-056', 'Raspberry Mousse Cookie'],
  ['BS2-057', 'Wizard Cookie'],
  ['BS2-058', 'Wind Archer Cookie'],
  ['BS2-059', 'Cherry Blossom Cookie'],
  ['BS2-060', 'Beet Cookie'],
  ['BS2-061', 'Hydrangea Cookie'],
  ['BS2-062', 'Starfruit Cookie'],
  ['BS2-063', 'Space Doughnut'],
  ['BS2-064', 'Alchemist Cookie'],
  ['BS2-065', 'Purple Yam Cookie'],
  ['BS2-066', 'Rose Cookie'],
  ['BS2-067', 'Angel Cookie'],
  ['BS2-068', 'Cream Unicorn Cookie'],
  ['BS2-069', 'Clotted Cream Cookie'],
  ['BS2-070', 'Kiwi Cookie'],
  ['BS2-071', 'Twizzly Gummy Cookie'],
  ['BS2-072', 'Pastry Cookie'],
  ['BS2-073', 'Peperoncino Cookie'],
  ['BS2-074', 'Pink Choco Cookie'],
  ['BS2-075', 'White Choco Cookie'],
  ['BS2-076', 'Hero Cookie'],
  ['BS2-077', 'Forbidden Incantation'],
  ['BS2-078', "Dragon's Breath"],
  ['BS2-079', 'Yew Village Scroll'],
  ['BS2-080', 'Abandoned Cloud Nest'],
  ['BS2-081', "Blue Dragon's Eye"],
]

const BLUE_CARDS = [
  ['BS2-022', 'Licorice Cookie'],
  ['BS2-023', 'DJ Cookie'],
  ['BS2-024', 'Strawberry Cookie'],
  ['BS2-025', 'Mango Cookie'],
  ['BS2-026', 'Mocha Ray Cookie'],
  ['BS2-027', 'Cotton Cookie'],
  ['BS2-028', 'Pond Dino Cookie'],
  ['BS2-029', 'Sea Fairy Cookie'],
  ['BS2-030', 'Gumball Cookie'],
  ['BS2-031', 'Black Raisin Cookie'],
  ['BS2-032', 'Blueberry Pie Cookie'],
  ['BS2-033', 'Sorbet Shark Cookie'],
  ['BS2-034', 'Frost Queen Cookie'],
  ['BS2-035', 'Salt Cookie'],
  ['BS2-036', 'Sherbet Cookie'],
  ['BS2-037', 'Chocolate Bonbon Cookie'],
  ['BS2-038', 'Sparkling Cookie'],
  ['BS2-039', 'Avocado Cookie'],
  ['BS2-040', 'Aloe Cookie'],
  ['BS2-041', 'Eggnog Cookie'],
  ['BS2-042', 'Milk Cookie'],
  ['BS2-043', 'Captain Ice Cookie'],
  ['BS2-044', 'Tiramisu Cookie'],
  ['BS2-045', 'Parfait Cookie'],
  ['BS2-046', 'Caramel Arrow Cookie'],
  ['BS2-047', 'Diving Goggles'],
  ['BS2-048', 'Jellied Jellyfish Potion'],
  ['BS2-049', 'Salt Crystal Trident'],
  ['BS2-050', "Hermit Crab's Shell"],
  ['BS2-051', 'Whipped Snowcream Village'],
]

const ALL_CARDS = [
  ...PURPLE_CARDS.map(([num, name]) => ({ num, name, set: 'PURPLE' })),
  ...BLUE_CARDS.map(([num, name]) => ({ num, name, set: 'BLUE' })),
]
...
try {
  ...
  console.log(`\n=== BS2 PURPLE + BLUE card validation (${ALL_CARDS.length} cards) ===`)
