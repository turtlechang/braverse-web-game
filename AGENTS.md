...
- 已知驗證限制：完整 `npm run test:ai:browser` 已於本機全綠（種子 1–20 與十四種解析度）。藍牌專項瀏覽器驗證於 1366×768、900×506 通過 ST4-012／013 與 ST4-016～020 的使用、付款、目標及決策流程。
