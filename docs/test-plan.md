...
最後更新：2026-07-12。現況為 96 個測試檔、1526 項 vitest 測試（非永久門檻） + 3 套 Playwright 瀏覽器驗證；本輪 AI 瀏覽器 20/20、stuck=0。

> 2026-07-12 更新：AI Playwright smoke 已綁定 main push 自動執行，但不在每次 PR 執行以控制成本；牌組編輯器與線上對戰仍無完整瀏覽器測試。
