...
- 目前共有 533 項單元測試；新增 ST4-016／017 返回手牌但不補位、戰鬥區至少保留 1 張餅乾、ST4-018 抽 0～2 張與 Refresh、ST4-019 洗回重抽及 AI 可重現洗牌、ST4-020 自選 2 張手牌支付陷阱代價的完整規則與 UI 測試，並覆蓋 AI 連續操作安全計數在控制權回到玩家後歸零，避免合法長局因整場累計達 200 步而卡住。
