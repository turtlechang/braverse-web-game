...
| 日期 | 概要 |
| --- | --- |
| 2026-08-21 | 修正 AI 攻擊無可用回應時可能卡住的戰鬥轉移：回應窗改以 microtask 略過，並保留巢狀決策；BS3-010 攻擊 BS4-024 的對戰紀錄與行動者顯示同步修正，新增正式卡池 AI 攻擊鏈回歸。完整 Vitest 211 檔／3,412 項、lint、build 與 localhost Browser smoke 通過。 |
