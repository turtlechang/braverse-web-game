...
try {
  ...
  for (const viewport of [
    ...
    const deckEditorButton = page.locator('[data-testid="open-deck-editor"]')
    await deckEditorButton.waitFor({ state: 'visible' })
    await deckEditorButton.click()
    const deckEditor = page.locator('[data-testid="deck-editor-page"]')
    await deckEditor.waitFor({ state: 'visible' })
    await deckEditor.locator('[data-testid="deck-editor-page-back"]').click()
    await deckEditor.waitFor({ state: 'hidden' })
