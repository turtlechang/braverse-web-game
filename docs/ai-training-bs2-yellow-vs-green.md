...
主要敗因幾乎都是 `break-level-limit`。黃色自動策略常把低 HP、低等級餅乾補上戰鬥區，導致黃色破壞區等級快速堆高（平均 10.5），而綠色只有 7.0。
...
- 綠色破壞區有 7 張：Onion (Lv2)、Red Bean (Lv2)、Candlelight (Lv1)、Melon Bun (Lv1)、2 個 Spinach (Lv1)、Angel (Lv1)
- 黃色棄牌 13 張，綠色 20 張
...
- 綠色破壞區有 5 張：Melon Bun (Lv1)、2 個 Red Bean (Lv2)、Angel (Lv1)、Ninja (Lv1)
- 黃色棄牌 17 張，綠色 25 張
...
- 綠色破壞區有 6 張：Red Bean (Lv2)、Candlelight (Lv1)、Angel (Lv1)、Salt (Lv1)、Angel (Lv1)、Cookiemals (Lv1)
- 黃色棄牌 16 張，綠色 18 張
...
- 綠色破壞區有 5 張：Cookiemals (Lv1)、Angel (Lv1)、Red Bean (Lv2)、Spinach (Lv1)、Red Bean (Lv2)
- 黃色棄牌 17 張，綠色 20 張
...
- 綠色破壞區有 6 張：Red Bean (Lv2)、Bellflower (Lv1)、Angel (Lv1)、2 個 Onion (Lv2)、Ninja (Lv1)
- 黃色棄牌 16 張，綠色 26 張
...
- 綠色破壞區有 5 張：Banana (Lv1)、Cookiemals (Lv1)、Spinach (Lv1)、Red Bean (Lv2)、Cookiemals (Lv1)
- 黃色棄牌 17 張，綠色 11 張
...
- 綠色破壞區只有 3 張：Angel (Lv1)、2 個 Cookiemals (Lv1)
- 黃色棄牌 13 張，綠色 7 張
...
- 綠色破壞區只有 3 張：Angel (Lv1)、Cookiemals (Lv1)、Angel (Lv1)
- 黃色棄牌 10 張，綠色 8 張
...
- 綠色破壞區只有 2 張：Bellflower (Lv1)、Spinach (Lv1)
- 黃色棄牌 14 張，綠色 8 張
...
**平均破壞區等級：** 黃色 10.5，綠色 7.0

## 關鍵操作心得（黃色對綠色）

### 1. 替補不要選最低 HP

黃色現有 AI 傾向補低 HP 餅乾，對綠色很危險。
...
黃色若把 HP 1 餅乾放成第二隻，綠色常能用攻擊或效果快速換掉。
...
不要只用「最低 HP」作為唯一目標。綠色有些低 HP 餅乾（Angel、Spinach）即使擊倒也對黃色幫助不大。
...
2. **部署**：Lv3 餅乾（Blackberry、Earl Grey）不要過早鋪上，容易被綠色快速換掉
3. **攻擊**：優先擊倒 Red Bean > Onion > Blue Lily
4. **防守**：保留 Super-Vita Jelly Bar、Winding Key Shield 到綠色鋪場後再用
5. **節奏**：黃色靠耐久換時間，早期建立防線，後期讓綠色破壞區先滿
